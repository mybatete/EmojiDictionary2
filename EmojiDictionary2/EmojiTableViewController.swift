...
class EmojiTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        //step 16 as the as to downcast to my emojitabvc
...
//        cell.detailTextLabel?.text = emoji.description
        ...
        //step 17 remove prev and change tto
    ...
    //step 20 remove this page 645
//    //step 8 add did select
...
//    }
    ...
    //step 21 create the static view with 4 sect and 1 row but it comes with 3 deleted 2
